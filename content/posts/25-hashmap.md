...
在 JDK1.8 中 HashMap 采用的是数组加链表加红黑树。而我写的是一个阉割版的 HashMap ，阉割了红黑树和部分边界条件的判断。参考了 JDK 的优化改进。除此之外采用了 Junit 做单元测试。
...
以字符串 “weijiew“ 为例。根据 ASC 编码，强制转换为整形后结果为：119 101 105 106 105 101 119 .

那么该方法中循环的实际计算流程如下：

$$
var1 = ((((((((31\times 0)119)101)105)106)105)101)119) = 1230531596
$$
